...
const TableNameWinAgentUserReportUsdt = "win_agent_user_report_usdt"
...
// TableName WinAgentUserReportUsdt's table name
func (*WinAgentUserReportUsdt) TableName() string {
	return TableNameWinAgentUserReportUsdt
}
