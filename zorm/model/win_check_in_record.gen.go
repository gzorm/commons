...
type WinCheckInRecord struct {
	...
	SupUID      int64           `gorm:"column:sup_uid;type:int;not null;comment:上级代理ID" json:"supUid"`                   // 上级代理ID
	...
	Status      int64           `gorm:"column:status;type:tinyint;not null;default:1;comment:状态：1有效0无效" json:"status"`   // 状态：1有效0无效
