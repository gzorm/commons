...
type WinUserLevelTmp struct {
	...
	ScoreUpgradeRate int64  `gorm:"column:score_upgrade_rate;type:int;comment:经验率" json:"scoreUpgradeRate"`          // 经验率
	ScoreUpgradeMax  int64  `gorm:"column:score_upgrade_max;type:int;comment:最大经验值" json:"scoreUpgradeMax"`          // 最大经验值
	ScoreUpgradeMin  int64  `gorm:"column:score_upgrade_min;type:int;comment:最小经验值" json:"scoreUpgradeMin"`          // 最小经验值
