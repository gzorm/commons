...
const TableNameWinCoinWithdrawalRecordM2 = "win_coin_withdrawal_record_m2s"
...
// TableName WinCoinWithdrawalRecordM2's table name
func (*WinCoinWithdrawalRecordM2) TableName() string {
	return TableNameWinCoinWithdrawalRecordM2
}
