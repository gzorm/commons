...
type WinPayChannel struct {
	...
	MinCoin            decimal.Decimal `gorm:"column:min_coin;type:decimal(10,4)" json:"minCoin"`
	MaxCoin            decimal.Decimal `gorm:"column:max_coin;type:decimal(10,4)" json:"maxCoin"`
