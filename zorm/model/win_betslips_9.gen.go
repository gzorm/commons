...
const TableNameWinBetslips9 = "win_betslips_9"

// WinBetslips9 mapped from table <win_betslips_9>
...
// TableName WinBetslips9's table name
func (*WinBetslips9) TableName() string {
	return TableNameWinBetslips9
}
