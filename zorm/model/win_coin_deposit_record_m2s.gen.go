...
const TableNameWinCoinDepositRecordM2 = "win_coin_deposit_record_m2s"
...
type WinCoinDepositRecordM2 struct {
	...
	PayAddress       string          `gorm:"column:pay_address;type:mediumtext;comment:加密地址" json:"payAddress"`                                                                    // 加密地址
	...
	Category         int64           `gorm:"column:category;type:tinyint;not null;comment:类型:0-钱包充值 1-佣金钱包转账充值" json:"category"`                                                   // 类型:0-钱包充值 1-佣金钱包转账充值
	...
	InviteCode       string          `gorm:"column:invite_code;type:varchar(20);not null;comment:邀请码" json:"inviteCode"` // 邀请码
}

// TableName WinCoinDepositRecordM2's table name
func (*WinCoinDepositRecordM2) TableName() string {
	return TableNameWinCoinDepositRecordM2
}
