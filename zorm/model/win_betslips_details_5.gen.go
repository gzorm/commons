...
const TableNameWinBetslipsDetails5 = "win_betslips_details_5"

// WinBetslipsDetails5 mapped from table <win_betslips_details_5>
...
// TableName WinBetslipsDetails5's table name
func (*WinBetslipsDetails5) TableName() string {
	return TableNameWinBetslipsDetails5
}
