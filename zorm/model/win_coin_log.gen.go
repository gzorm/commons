...
type WinCoinLog struct {
	...
	Code         string          `gorm:"column:code;type:varchar(64);comment:支付通道编码" json:"code"`                                                                                                                                            // 支付通道编码
	...
	OrderID      string          `gorm:"column:order_id;type:varchar(100);comment:订单id" json:"orderId"`                                                                                                                                      // 订单id
