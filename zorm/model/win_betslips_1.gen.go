...
const TableNameWinBetslips1 = "win_betslips_1"

// WinBetslips1 mapped from table <win_betslips_1>
...
// TableName WinBetslips1's table name
func (*WinBetslips1) TableName() string {
	return TableNameWinBetslips1
}
