...
const TableNameWinCoinLog5 = "win_coin_log_5"

// WinCoinLog5 mapped from table <win_coin_log_5>
...
// TableName WinCoinLog5's table name
func (*WinCoinLog5) TableName() string {
	return TableNameWinCoinLog5
}
