...
type WinGameSlot struct {
	...
	GameID       int64  `gorm:"column:game_id;type:int;comment:游戏ID(关联game_list)" json:"gameId"`                                                                 // 游戏ID(关联game_list)
	...
	PlatID       int64  `gorm:"column:plat_id;type:bigint;comment:游戏平台id" json:"platId"`                                                                         // 游戏平台id
