...
type WinPromotions struct {
	...
	Code           string          `gorm:"column:code;type:varchar(64);comment:活动标识:首充优惠-First Deposit Bonus 续充优惠-Second Deposit Bonus 首单包赔-Risk-Free Bet 快乐周末-Happy Weekend Bonus" json:"code"` // 活动标识:首充优惠-First Deposit Bonus 续充优惠-Second Deposit Bonus 首单包赔-Risk-Free Bet 快乐周末-Happy Weekend Bonus
	CodeZh         string          `gorm:"column:code_zh;type:varchar(255);comment:名称中文" json:"codeZh"`                                                                                          // 名称中文
	...
	Category       string          `gorm:"column:category;type:varchar(16);not null;default:0;comment:类型:1-充值优惠 2-豪礼赠送 3-新活动 4-签到活动" json:"category"`                                            // 类型:1-充值优惠 2-豪礼赠送 3-新活动 4-签到活动
