...
const TableNameWinBetslips5 = "win_betslips_5"

// WinBetslips5 mapped from table <win_betslips_5>
...
// TableName WinBetslips5's table name
func (*WinBetslips5) TableName() string {
	return TableNameWinBetslips5
}
