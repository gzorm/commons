...
type WinCoinCommissionLog struct {
	...
	UID        int64           `gorm:"column:uid;type:int" json:"uid"`
	Username   string          `gorm:"column:username;type:varchar(32);comment:用户名" json:"username"`                          // 用户名
	Category   int64           `gorm:"column:category;type:tinyint;default:1;comment:类型:1-返佣 2- 佣金充值 3-佣金提款" json:"category"` // 类型:1-返佣 2- 佣金充值 3-佣金提款
	...
	OutIn      int64           `gorm:"column:out_in;type:tinyint;comment:收支类型:0-支出 1-收入" json:"outIn"`                        // 收支类型:0-支出 1-收入
	CoinBefore decimal.Decimal `gorm:"column:coin_before;type:decimal(15,4);default:0.0000;comment:前金额" json:"coinBefore"`    // 前金额
	CoinAfter  decimal.Decimal `gorm:"column:coin_after;type:decimal(15,4);default:0.0000;comment:帐变后金额" json:"coinAfter"`    // 帐变后金额
