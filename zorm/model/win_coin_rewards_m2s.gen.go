...
const TableNameWinCoinRewardsM2 = "win_coin_rewards_m2s"
...
// TableName WinCoinRewardsM2's table name
func (*WinCoinRewardsM2) TableName() string {
	return TableNameWinCoinRewardsM2
}
