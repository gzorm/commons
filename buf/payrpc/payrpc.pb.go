...
var file_payrpc_proto_rawDesc = string([]byte{
	...
	0x61, 0x6c, 0x43, 0x6f, 0x69, 0x6e, 0x32, 0xc4, 0x2b, 0x0a, 0x06, 0x70, 0x61, 0x79, 0x72, 0x70,
	...
	0x64, 0x72, 0x61, 0x77, 0x61, 0x6c, 0x53, 0x75, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x42, 0x0a, 0x5a,
	0x08, 0x2e, 0x2f, 0x70, 0x61, 0x79, 0x72, 0x70, 0x63, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
})
...
var file_payrpc_proto_msgTypes = make([]protoimpl.MessageInfo, 199)
...
var file_payrpc_proto_depIdxs = []int32{
	...
	0,   // 70: payrpc.payrpc.bindAccount:input_type -> payrpc.BindAccountReq
	2,   // 71: payrpc.payrpc.payAccount:input_type -> payrpc.PayAccountReq
	5,   // 72: payrpc.payrpc.withdrawConfig:input_type -> payrpc.WithdrawConfigReq
	8,   // 73: payrpc.payrpc.channelList:input_type -> payrpc.ChannelListReq
	13,  // 74: payrpc.payrpc.deposit:input_type -> payrpc.DepositReq
	15,  // 75: payrpc.payrpc.depositCallBack:input_type -> payrpc.DepositCallBackReq
	117, // 76: payrpc.payrpc.depositByWowIdrCallBack:input_type -> payrpc.DepositByWowIdrCallBackReq
	119, // 77: payrpc.payrpc.depositByBasePayCallBack:input_type -> payrpc.DepositByBasePayCallBackReq
	125, // 78: payrpc.payrpc.depositByMoonPayCallBack:input_type -> payrpc.DepositByMoonPayCallBackReq
	127, // 79: payrpc.payrpc.depositByBfPayCallBack:input_type -> payrpc.DepositByBfPayCallBackReq
	131, // 80: payrpc.payrpc.depositBySixPayCallBack:input_type -> payrpc.DepositBySixPayCallBackReq
	133, // 81: payrpc.payrpc.depositByAiPayCallBack:input_type -> payrpc.DepositByAiPayCallBackReq
	168, // 82: payrpc.payrpc.depositByAPayCallBack:input_type -> payrpc.DepositByAPayCallBackReq
	17,  // 83: payrpc.payrpc.depositSearch:input_type -> payrpc.DepositSearchReq
	11,  // 84: payrpc.payrpc.withdraws:input_type -> payrpc.WithdrawReq
	19,  // 85: payrpc.payrpc.withdrawCallBack:input_type -> payrpc.WithdrawCallBackReq
	121, // 86: payrpc.payrpc.withdrawByWowIdrCallBack:input_type -> payrpc.WithdrawByWowIdrCallBackReq
	123, // 87: payrpc.payrpc.withdrawByBasePayCallBack:input_type -> payrpc.WithdrawByBasePayCallBackReq
	139, // 88: payrpc.payrpc.withdrawByMoonPayCallBack:input_type -> payrpc.WithdrawByMoonPayCallBackReq
	141, // 89: payrpc.payrpc.withdrawByBfPayCallBack:input_type -> payrpc.WithdrawByBfPayCallBackReq
	137, // 90: payrpc.payrpc.withdrawBySixPayCallBack:input_type -> payrpc.WithdrawBySixPayCallBackReq
	135, // 91: payrpc.payrpc.withdrawByAiPayCallBack:input_type -> payrpc.WithdrawByAiPayCallBackReq
	170, // 92: payrpc.payrpc.withdrawByAPayCallBack:input_type -> payrpc.WithdrawByAPayCallBackReq
	21,  // 93: payrpc.payrpc.withdrawSearch:input_type -> payrpc.WithdrawSearchReq
	23,  // 94: payrpc.payrpc.findMerchantBlance:input_type -> payrpc.FindMerchantBlanceReq
	25,  // 95: payrpc.payrpc.refundOrder:input_type -> payrpc.RefundOrderReq
	27,  // 96: payrpc.payrpc.refundOrderCallBack:input_type -> payrpc.RefundOrderCallBackReq
	29,  // 97: payrpc.payrpc.checkDeposit:input_type -> payrpc.CheckDepositReq
	31,  // 98: payrpc.payrpc.getCoinLogList:input_type -> payrpc.GetCoinLogListReq
	36,  // 99: payrpc.payrpc.getAuditWithdrawalRecord:input_type -> payrpc.GetAuditWithdrawalRecordReq
	36,  // 100: payrpc.payrpc.getWithdrawalRecord:input_type -> payrpc.GetAuditWithdrawalRecordReq
	42,  // 101: payrpc.payrpc.getDepositWithdrawalStatistics:input_type -> payrpc.GetDepositWithdrawalStatisticsReq
	45,  // 102: payrpc.payrpc.isAudit:input_type -> payrpc.IsAuditReq
	48,  // 103: payrpc.payrpc.financeWithDraw:input_type -> payrpc.FinanceWithDrawReq
	50,  // 104: payrpc.payrpc.dailyReportStatisticsCount:input_type -> payrpc.DailyReportStatisticsCountReq
	53,  // 105: payrpc.payrpc.getUserCoin:input_type -> payrpc.GetUserCoinReq
	56,  // 106: payrpc.payrpc.coinRateList:input_type -> payrpc.CoinRateReq
	60,  // 107: payrpc.payrpc.pagcorDailyTax:input_type -> payrpc.PagcorDailyTaxReq
	65,  // 108: payrpc.payrpc.getDepositRecord:input_type -> payrpc.GetDepositRecordReq
	70,  // 109: payrpc.payrpc.getFrontWithdrawalRecord:input_type -> payrpc.GetFrontWithdrawalRecordReq
	75,  // 110: payrpc.payrpc.totalSummary:input_type -> payrpc.TotalSummaryReq
	78,  // 111: payrpc.payrpc.depositAndWithdrawalChart:input_type -> payrpc.DepositAndWithdrawalChartReq
	82,  // 112: payrpc.payrpc.dailyConversionReportList:input_type -> payrpc.DailyConversionReportListReq
	87,  // 113: payrpc.payrpc.dailyConversionReportStatistics:input_type -> payrpc.DailyConversionReportStatisticsReq
	90,  // 114: payrpc.payrpc.platBetCoinChart:input_type -> payrpc.PlatBetCoinChartReq
	93,  // 115: payrpc.payrpc.walletOutTransfer:input_type -> payrpc.WalletOutTransferReq
	95,  // 116: payrpc.payrpc.replenishmentOrder:input_type -> payrpc.ReplenishmentOrderReq
	97,  // 117: payrpc.payrpc.withdrawalList:input_type -> payrpc.WithdrawalListReq
	102, // 118: payrpc.payrpc.withdrawalStatistics:input_type -> payrpc.WithdrawalStatisticsReq
	105, // 119: payrpc.payrpc.depositRecordList:input_type -> payrpc.DepositRecordListReq
	111, // 120: payrpc.payrpc.depositSum:input_type -> payrpc.DepositSumReq
	114, // 121: payrpc.payrpc.payAllChannelList:input_type -> payrpc.PayAllChannelListReq
	145, // 122: payrpc.payrpc.updateWithdrawalStatus:input_type -> payrpc.UpdateWithdrawalStatusReq
	150, // 123: payrpc.payrpc.auditWithdrawalSum:input_type -> payrpc.AuditWithdrawalSumReq
	153, // 124: payrpc.payrpc.cancelWithDraw:input_type -> payrpc.CancelWithDrawReq
	155, // 125: payrpc.payrpc.depositChannelList:input_type -> payrpc.DepositChannelListReq
	148, // 126: payrpc.payrpc.editChannel:input_type -> payrpc.EditChannelReq
	160, // 127: payrpc.payrpc.depositList:input_type -> payrpc.AdminDepositListReq
	165, // 128: payrpc.payrpc.depositStatistics:input_type -> payrpc.AdminDepositStatisticsReq
	172, // 129: payrpc.payrpc.getWithdrawalAddressType:input_type -> payrpc.GetWithdrawalAddressTypeReq
	175, // 130: payrpc.payrpc.payChannelList:input_type -> payrpc.PayChannelListReq
	180, // 131: payrpc.payrpc.payPlatList:input_type -> payrpc.PayPlatListReq
	185, // 132: payrpc.payrpc.adminTransferList:input_type -> payrpc.AdminTransferListReq
	190, // 133: payrpc.payrpc.adminTransferStatistics:input_type -> payrpc.AdminTransferStatisticsReq
	193, // 134: payrpc.payrpc.getChannelList:input_type -> payrpc.GetChannelListReq
	196, // 135: payrpc.payrpc.WithdrawalSum:input_type -> payrpc.WithdrawalSumReq
	1,   // 136: payrpc.payrpc.bindAccount:output_type -> payrpc.BindAccountResp
	3,   // 137: payrpc.payrpc.payAccount:output_type -> payrpc.PayAccountResp
	6,   // 138: payrpc.payrpc.withdrawConfig:output_type -> payrpc.WithdrawConfigResp
	9,   // 139: payrpc.payrpc.channelList:output_type -> payrpc.ChannelListResp
	14,  // 140: payrpc.payrpc.deposit:output_type -> payrpc.DepositResp
	16,  // 141: payrpc.payrpc.depositCallBack:output_type -> payrpc.DepositCallBackResp
	118, // 142: payrpc.payrpc.depositByWowIdrCallBack:output_type -> payrpc.DepositByWowIdrCallBackResp
	120, // 143: payrpc.payrpc.depositByBasePayCallBack:output_type -> payrpc.DepositByBasePayCallBackResp
	126, // 144: payrpc.payrpc.depositByMoonPayCallBack:output_type -> payrpc.DepositByMoonPayCallBackResp
	130, // 145: payrpc.payrpc.depositByBfPayCallBack:output_type -> payrpc.DepositByBfPayCallBackResp
	132, // 146: payrpc.payrpc.depositBySixPayCallBack:output_type -> payrpc.DepositBySixPayCallBackResp
	134, // 147: payrpc.payrpc.depositByAiPayCallBack:output_type -> payrpc.DepositByAiPayCallBackResp
	169, // 148: payrpc.payrpc.depositByAPayCallBack:output_type -> payrpc.DepositByAPayCallBackResp
	18,  // 149: payrpc.payrpc.depositSearch:output_type -> payrpc.DepositSearchResp
	12,  // 150: payrpc.payrpc.withdraws:output_type -> payrpc.WithdrawResp
	20,  // 151: payrpc.payrpc.withdrawCallBack:output_type -> payrpc.WithdrawCallBackResp
	122, // 152: payrpc.payrpc.withdrawByWowIdrCallBack:output_type -> payrpc.WithdrawByWowIdrCallBackResp
	124, // 153: payrpc.payrpc.withdrawByBasePayCallBack:output_type -> payrpc.WithdrawByBasePayCallBackResp
	140, // 154: payrpc.payrpc.withdrawByMoonPayCallBack:output_type -> payrpc.WithdrawByMoonPayCallBackResp
	144, // 155: payrpc.payrpc.withdrawByBfPayCallBack:output_type -> payrpc.WithdrawByBfPayCallBackResp
	138, // 156: payrpc.payrpc.withdrawBySixPayCallBack:output_type -> payrpc.WithdrawBySixPayCallBackResp
	136, // 157: payrpc.payrpc.withdrawByAiPayCallBack:output_type -> payrpc.WithdrawByAiPayCallBackResp
	171, // 158: payrpc.payrpc.withdrawByAPayCallBack:output_type -> payrpc.WithdrawByAPayCallBackResp
	22,  // 159: payrpc.payrpc.withdrawSearch:output_type -> payrpc.WithdrawSearchResp
	24,  // 160: payrpc.payrpc.findMerchantBlance:output_type -> payrpc.FindMerchantBlanceResp
	26,  // 161: payrpc.payrpc.refundOrder:output_type -> payrpc.RefundOrderResp
	28,  // 162: payrpc.payrpc.refundOrderCallBack:output_type -> payrpc.RefundOrderCallBackResp
	30,  // 163: payrpc.payrpc.checkDeposit:output_type -> payrpc.CheckDepositResp
	33,  // 164: payrpc.payrpc.getCoinLogList:output_type -> payrpc.GetCoinLogListResp
	38,  // 165: payrpc.payrpc.getAuditWithdrawalRecord:output_type -> payrpc.GetAuditWithdrawalRecordResp
	38,  // 166: payrpc.payrpc.getWithdrawalRecord:output_type -> payrpc.GetAuditWithdrawalRecordResp
	43,  // 167: payrpc.payrpc.getDepositWithdrawalStatistics:output_type -> payrpc.GetDepositWithdrawalStatisticsResp
	46,  // 168: payrpc.payrpc.isAudit:output_type -> payrpc.IsAuditResp
	49,  // 169: payrpc.payrpc.financeWithDraw:output_type -> payrpc.FinanceWithDrawResp
	51,  // 170: payrpc.payrpc.dailyReportStatisticsCount:output_type -> payrpc.DailyReportStatisticsCountResp
	54,  // 171: payrpc.payrpc.getUserCoin:output_type -> payrpc.GetUserCoinResp
	57,  // 172: payrpc.payrpc.coinRateList:output_type -> payrpc.CoinRateResp
	62,  // 173: payrpc.payrpc.pagcorDailyTax:output_type -> payrpc.PagcorDailyTaxResp
	67,  // 174: payrpc.payrpc.getDepositRecord:output_type -> payrpc.GetDepositRecordResp
	72,  // 175: payrpc.payrpc.getFrontWithdrawalRecord:output_type -> payrpc.GetFrontWithdrawalRecordResp
	76,  // 176: payrpc.payrpc.totalSummary:output_type -> payrpc.TotalSummaryResp
	79,  // 177: payrpc.payrpc.depositAndWithdrawalChart:output_type -> payrpc.DepositAndWithdrawalChartResp
	84,  // 178: payrpc.payrpc.dailyConversionReportList:output_type -> payrpc.DailyConversionReportListResp
	88,  // 179: payrpc.payrpc.dailyConversionReportStatistics:output_type -> payrpc.DailyConversionReportStatisticsResp
	91,  // 180: payrpc.payrpc.platBetCoinChart:output_type -> payrpc.PlatBetCoinChartResp
	94,  // 181: payrpc.payrpc.walletOutTransfer:output_type -> payrpc.WalletOutTransferResp
	96,  // 182: payrpc.payrpc.replenishmentOrder:output_type -> payrpc.ReplenishmentOrderResp
	99,  // 183: payrpc.payrpc.withdrawalList:output_type -> payrpc.WithdrawalListResp
	103, // 184: payrpc.payrpc.withdrawalStatistics:output_type -> payrpc.WithdrawalStatisticsResp
	107, // 185: payrpc.payrpc.depositRecordList:output_type -> payrpc.DepositRecordListResp
	112, // 186: payrpc.payrpc.depositSum:output_type -> payrpc.DepositSumResp
	115, // 187: payrpc.payrpc.payAllChannelList:output_type -> payrpc.PayAllChannelListResp
	146, // 188: payrpc.payrpc.updateWithdrawalStatus:output_type -> payrpc.UpdateWithdrawalStatusResp
	151, // 189: payrpc.payrpc.auditWithdrawalSum:output_type -> payrpc.AuditWithdrawalSumResp
	154, // 190: payrpc.payrpc.cancelWithDraw:output_type -> payrpc.CancelWithDrawResp
	157, // 191: payrpc.payrpc.depositChannelList:output_type -> payrpc.DepositChannelListResp
	149, // 192: payrpc.payrpc.editChannel:output_type -> payrpc.EditChannelResp
	162, // 193: payrpc.payrpc.depositList:output_type -> payrpc.AdminDepositListResp
	166, // 194: payrpc.payrpc.depositStatistics:output_type -> payrpc.AdminDepositStatisticsResp
	173, // 195: payrpc.payrpc.getWithdrawalAddressType:output_type -> payrpc.GetWithdrawalAddressTypeResp
	177, // 196: payrpc.payrpc.payChannelList:output_type -> payrpc.PayChannelListResp
	182, // 197: payrpc.payrpc.payPlatList:output_type -> payrpc.PayPlatListResp
	187, // 198: payrpc.payrpc.adminTransferList:output_type -> payrpc.AdminTransferListResp
	191, // 199: payrpc.payrpc.adminTransferStatistics:output_type -> payrpc.AdminTransferStatisticsResp
	194, // 200: payrpc.payrpc.getChannelList:output_type -> payrpc.GetChannelListResp
	197, // 201: payrpc.payrpc.WithdrawalSum:output_type -> payrpc.WithdrawalSumResp
